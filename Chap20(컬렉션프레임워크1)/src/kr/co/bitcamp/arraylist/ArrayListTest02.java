...
public class ArrayListTest02 {
    ...
    public static void main(String[] args) {
        ...
        ArrayList list2 = new ArrayList(list1.subList(1, 4)); //1번 인덱스부터 4번 인덱스까지 
        print(list1, list2);
        ...
        //추가하기
        list2.add("B");             //배열 복사가 일어니지 않음
        list2.add("C");             //배열 복사가 일어니지 않음
        print(list1, list2);
        ...
        //삭제하기 - list2에서 list1에 포함된 객체들을 삭제하기
        System.out.println("포함된 객체 삭제하기");
        
        for(int i=list2.size()-1; i>=0; i--) {
            if(list1.contains(list2.get(i))) {  //list2의 i번째 값이 list1에 포함될 때
                list2.remove(i);
            }
            print(list1, list2);
        }
